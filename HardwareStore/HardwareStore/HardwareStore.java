...
public class HardwareStore {
     ...
     */
    public static Object[]  addNewSmallHardwareItem(String idNumber, String name, int quantity, float price, String category) {
        ...
        Object[] array = {idNumber, name, quantity, price, category};
        //invmodel.addRow(array);
     ...
     */
    public static void addQuantity(int itemIndex, int quantity) {
     ...
     */
    public static int findItemIndex(String idNumber) {
        int index = -1;
        for (int i = 0; i < itemList.size(); i++) {
     ...
     */
    public static int findUserIndex(int id) {
        int index = -1;
        for (int i = 0; i < userList.size(); i++) {
            if (userList.get(i).getId() == id) {
                index = i;
     ...
     * @param address a <CODE>String</CODE> representing the address of user
     */
    public static void editCustomerInformation(int idInput, String firstName, String lastName, String phoneNumber, String address) {
     ...
     */
    public static void progressTransaction(String itemId, int saleQuantity, int customerId, int employeeId, int itemIndex) {
